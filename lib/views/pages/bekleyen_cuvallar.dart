...
class BekleyenCuvallar extends StatefulWidget {
  const BekleyenCuvallar({super.key});

  @override
  State<BekleyenCuvallar> createState() => _BekleyenCuvallarState();
}

class _BekleyenCuvallarState extends State<BekleyenCuvallar> {
